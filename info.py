...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://SKARLETTTT:SKARLEETTTT@cluster0.dmktg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/y9M.jpg'))
REACTIONS = ["😱", "😈", "🎉", "⚡️", "😎", "🏆", "🔥", "👻"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
